...
TECHNICAL_SCORE_PRICE_ABOVE_SMA20 = 10
TECHNICAL_SCORE_GOLDEN_CROSS = 15
TECHNICAL_SCORE_MACD_POSITIVE = 5
TECHNICAL_SCORE_RSI_NEUTRAL = 25
TECHNICAL_SCORE_RSI_APPROACHING_OVERSOLD = 20
TECHNICAL_SCORE_RSI_OVERSOLD = 15
TECHNICAL_SCORE_RSI_APPROACHING_OVERBOUGHT = 10
TECHNICAL_SCORE_RSI_OVERBOUGHT = 0
TECHNICAL_SCORE_BB_BELOW_LOWER = 15
TECHNICAL_SCORE_BB_ABOVE_UPPER = 0
TECHNICAL_SCORE_BB_WITHIN = 8
TECHNICAL_SCORE_POSITIVE_VOLUME = 10
